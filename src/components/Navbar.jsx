  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      position='BottomCentre'>
        <div className='flex items-centre gap-2 cursor-pointer p-1 hover;bg-light-gray rounded-lg'
        onClick={()=> handleClick('userProfile')}>
          ...
          <p>
            ...
            <span className='text-gray-400 font-bold ml-1 text-14'>Hrishikesh</span>
          </p>
